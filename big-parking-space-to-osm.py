...
class DiscouragedOnewayValuesWriter(osmium.SimpleHandler):

    def __init__(self, writer):
        super(DiscouragedOnewayValuesWriter, self).__init__()
...
def main(input, output):
    try:
        ...
        handler = DiscouragedOnewayValuesWriter(writer)
